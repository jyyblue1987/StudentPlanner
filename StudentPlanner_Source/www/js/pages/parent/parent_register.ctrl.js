app.controller('ParentRegisterController', function ($scope, $rootScope, $state, $http, $ionicLoading,$ionicHistory, AuthService, ApiService, toaster ) {
  var vm = this;
  ...
  function initData() {
    ...
    vm.username = 'parent2@ebaraha.com';
  ...
  $scope.onClickRegister = function () {
    ...
    AuthService.register('parent', data)
